...
# path of the rtl-fuzz-lab repository root directory
root_path = os.path.relpath(os.path.dirname(__file__))
...
def main():
    ...
    for i in range(args.iterations):
        ...
        os.system('timeout {TIME_STRING}s {AFL_PATH}/afl-fuzz -d -i seeds -o {OUT_FOLDER_RUN} -f input -- ./afl-proxy/afl-proxy a2j j2a log'.format(
